 ...
 * | Response Msg Version2 with apiMetaData
 */
if (!function_exists("responseMsgsv1")) {
    function responseMsgsv1($status, $authStatus, $msg, $data, $apiId = null, $version = null, $queryRunTime = null, $action = null, $deviceId = null)
    {
        return response()->json([
            'status' => $status,
