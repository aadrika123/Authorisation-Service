...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::controller(MenuController::class)->group(function () {
        ...
        Route::post('menu-submenu/update-by-id', 'updateMaintenance');
    });
    ...
    Route::controller(ApiRoleMapController::class)->group(function () {
        ...
        //
        Route::post('user-managment/v1/crud/api-role-map/save-v1', 'createApiRoleMap');
    ...
    Route::controller(DynamicTableController::class)->group(function () {
        ...
        Route::post('dynamic-table/module-completion-toggle', 'toggleCompletion');
    });
...
Route::middleware(['apiPermission'])->group(function () {
    Route::controller(ApiUnauthController::class)->group(function () {
        ...
        Route::post("property/ulb-wise-count-dashboard", "unAuthApis");
        Route::post("property/ulb-module-role-count-dashboard", "unAuthApis");
        Route::post("property/dashboard-summary-cards", "unAuthApis");
        # Property UnAuth Api
        ...
        Route::get("ptms-new/v1/prime-dashboard", "unAuthApis");
